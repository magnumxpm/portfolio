		...
		<div className="mt-4 flex relative w-full items-center justify-center gap-12 py-7 text-base sm:text-md">
			...
			<div className="flex gap-2 absolute right-4">
				<Link
					...
					className="px-6 py-2 flex gap-2 items-center xs:px-10 bg-dark text-gray-200 rounded-md text-base_mobile sm:text-base font-semibold leading-tight focus:bg-theme_light focus:outline-none focus:text-black hover:bg-theme_light hover:text-black transition duration-100"
				>
					<MailIcon size={22} />
					Let's Talk
				</Link>
